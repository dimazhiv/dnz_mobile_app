...
function DriverItem({
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.dateCell}><Text>{dateOfBirth}</Text></View>
            <View style={styles.countryCell}><Text numberOfLines={1}
                                                   ellipsizeMode={'tail'}>{nationality}</Text></View>
            <View style={styles.racesCell}>
                <TouchableOpacity
                    onPress={handleLinkPress}>
                    <Text style={styles.linkStyle} numberOfLines={1}>races</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
